...
class SMBConnection:
    ...
    def getFile(self, shareName, pathName, callback, offset = 0, shareAccessMode = None):
        """
        downloads a file
        ...
        :param int offset: offset of the file to retrieve
        ...
        try:
            if shareAccessMode is None:
                ...
                return self._SMBConnection.retr_file(shareName, pathName, callback, offset=offset)
            else:
                return self._SMBConnection.retr_file(shareName, pathName, callback, offset=offset, shareAccessMode=shareAccessMode)
        except (smb.SessionError, smb3.SessionError) as e:
            raise SessionError(e.get_error_code(), e.get_error_packet())
